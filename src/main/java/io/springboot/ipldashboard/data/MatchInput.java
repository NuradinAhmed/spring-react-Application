...
/*
1- We are creating the business class:


    Entity: this is the entity which will correspond to each row in the input data of the match in resource csv file.
 */

public class MatchInput{

    //Member variables from the csv file row header and declare them all to be private and type of string
    private String id;
    private String city;
    private String date;
    ...
    //Getters and Setter for the above Member Variables

    /*
        Getters and Setters: Why are they important ?
            ...
            By convention, getters start with the word "get" and setters with the word "set", followed by a variable name.
            In both cases the first letter of the variable's name is capitalized:
